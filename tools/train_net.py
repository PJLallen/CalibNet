...
sys.path.append(".")
from calibnet import add_calibnet_config, COCOMaskEvaluator
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        if cfg.MODEL.CALIBNET.DATASET_MAPPER == "RGBDSISDatasetMapper":
            from calibnet import RGBDSISTrainDatasetMapper
            mapper = RGBDSISTrainDatasetMapper(cfg, is_train=True)
        else:
            mapper = None
    ...
    def build_test_loader(cls, cfg, dataset_name):
        if cfg.MODEL.CALIBNET.DATASET_MAPPER == "RGBDSISDatasetMapper":
            from calibnet import RGBDSISTestDatasetMapper
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="calibnet")
    return cfg
